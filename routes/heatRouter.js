...
router.post('/group/', checkRole('ADMIN'), heatController.createFirstGroupHeats)
router.post('/next/', checkRole('ADMIN'), heatController.createNextRoundsHeats)
router.post('/team_next/', checkRole('ADMIN'), heatController.createNextRoundTeamHeats)
